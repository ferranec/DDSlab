...
events$dtcpb <- NULL
events$dmeansz<- NULL
events$trans_depth <- NULL
events$res_bdy_len <- NULL
events$Sjit <- NULL
events$Djit <- NULL
events$Stime <- NULL
events$Ltime <- NULL
...
events$tcprtt <- NULL
events$ackdat <- NULL
events$is_sm_ips_ports <- NULL
events$ct_state_ttl <- NULL
events$ct_flw_http_mthd <- NULL
events$is_ftp_login <- NULL
events$ct_ftp_cmd <- NULL
events$ct_srv_src <- NULL
events$ct_dst_ltm <- NULL
events$ct_src_ltm <- NULL
events$ct_src_dport_ltm <- NULL
events$ct_dst_sport_ltm <- NULL
events$ct_dst_src_ltm <- NULL
events$attack_cat <- NULL

```
Conseguimos 0.9847939 con 13 variables
### Data enrichment
